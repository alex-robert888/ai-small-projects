...
def loadTexture():
    textureSurface = pygame.image.load('assets/texture_table.png')
...
class Mecanism():
    def __init__(self):
        ...
        self.roata = Corp("assets/roata.obj")
        self.masina = Corp("assets/masina.obj")
        self.pendul = Corp("assets/pendul.obj")
    ...
    def toRadian(self, angle):
        return angle / 180.0 * pygame.math.pi
